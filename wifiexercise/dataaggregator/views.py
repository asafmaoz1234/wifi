...
def get_wifi_stats(request):
    ...
    data = {'wifiId': wifi.wifiId, 'avgThroughput': wifi.wifiAverageThroughPutRating}
...
def store_device_report(request):
    ...
    return HttpResponse(json.dumps({'deviceUdid': device_udid, 'wifiId': wifi_id, 'throughPut': wifi_through_put,
